	 ...
	 class TextListener implements ActionListener {
		 public void actionPerformed(ActionEvent event) {
			 ...
			 if(plainButton.isSelected())
				 meme.setFont(styleCombo.getSelectedItem().toString(),"Plain"  ,colorCombo.getSelectedItem().toString(),fontSizeField.getText().toString());
			 if(boldButton.isSelected())
				 meme.setFont(styleCombo.getSelectedItem().toString(),"Bold"   ,colorCombo.getSelectedItem().toString(),fontSizeField.getText().toString());
			 if(italicButton.isSelected())
				 meme.setFont(styleCombo.getSelectedItem().toString(),"Italic" ,colorCombo.getSelectedItem().toString(),fontSizeField.getText().toString());
