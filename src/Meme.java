...
public class Meme {
 ...
 public void setFont(String fontStyle, String fontChange, String fontColor, String fontSize) {
  switch(fontChange) {
  case "Plain"  : font = new Font(fontStyle, 0, Integer.parseInt(fontSize));break;
  case "Bold"   : font = new Font(fontStyle, 1, Integer.parseInt(fontSize));break;
  case "Italic" : font = new Font(fontStyle, 2, Integer.parseInt(fontSize));break;
  }
